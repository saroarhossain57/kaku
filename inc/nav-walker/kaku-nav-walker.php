 ...
 * Kaku Navwalker
 *
 * @package kaku_nav_menu_walker
 *
 */

// Check if Class Exists.
if (!class_exists('kaku_nav_menu_walker')) :
  /**
   * kaku_nav_menu_walker class.
   */
  class kaku_nav_menu_walker extends Walker_Nav_Menu
  {
    ...
    public static function fallback($args)
    {
      ...
      $fallback_output .= '<li class="nav-item"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link" title="' . esc_attr__('Add a menu', 'kaku') . '">' . esc_html__('Add a menu', 'kaku') . '</a></li>';
      $fallback_output .= '</ul>';
